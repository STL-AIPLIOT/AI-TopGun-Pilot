...
namespace Action
{
    ...
    private:
        // Pure/Lag 분류 기준
        static constexpr float EPS_DEG = 4.0f;   // 허용오차
        static constexpr float HYS_DEG = 2.0f;   // 히스테리시스
        ...
        static constexpr float K_RANGE_CLOSE = 0.4f; // 멀수록 LOS 당김
        static constexpr float K_RANGE_TIGHT = 0.15f; // 너무 가깝게 붙었을 때 완화(Ht방향)
